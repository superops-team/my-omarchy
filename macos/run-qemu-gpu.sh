...
if hyprland_identity != "f0c05f9fe88e85d43a7f7db30372d73dbb9e995060fbac9bc5447a77a4e5c81d":
...
if ttfx != {
    ...
    "binarySha256": "e0bacc35a3a3e5d3cf3228560debd6d6322d0f03c07b72bbedf3895af9cf54a0",
...
echo "[qemu-gpu] Ready. QMP: $qmp_socket PID: $qemu_pid" >&2

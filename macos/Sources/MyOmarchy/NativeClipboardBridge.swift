...
final class NativeClipboardBridge {
    ...
    private let stateQueue = DispatchQueue(label: "team.superops.myomarchy.clipboard-bridge-state")
    private let writeQueue = DispatchQueue(label: "team.superops.myomarchy.clipboard-bridge-writes")

...
enum StorageLocationPolicyError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .volumeUnreadable(let path):
            "My Omarchy could not read the disk that holds \(path)."
...
enum StorageLocationPolicy {
    ...
    static let workspaceDirectoryName = "My Omarchy"
    static let rootMarkerName = ".my-omarchy-storage"
    ...
    /// named `.my-omarchy-storage` exists would let the picker accept a folder
